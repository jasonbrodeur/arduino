...
// Music
int melody[] = {NOTE_C4, 0, NOTE_C4, 0, NOTE_C5};
int noteDurations[] = {2, 2, 2, 2, 1, };
...
//int time;
int time_ctr;
double temp_array[24]={4,5,6,7,8,10,12,14,17,18,21,22,24,22,21,18,16,14,12,11,9,7,6,6};
int wx_array[24]={1,4,4,4,2,1,2,2,2,5,5,3,4,4,3,3,4,3,2,1,1,1,5,5};
...
void loop() {
  for(time_ctr = 0; time_ctr <24; time_ctr++){
    int time_input = time_ctr*100;
...
// function here that parses weather information and lights the appropriate pin
 ...
 switch (wx) {
    ...
    case 4: // Rain
      digitalWrite(A1,HIGH);
      //analogWrite(11,255);
      for (int bright = 0;  bright <52; bright = bright+1){analogWrite(11,bright*5); Serial.println(bright); delay(50);}
      for (int bright = 51; bright >-1;   bright = bright-1){analogWrite(11,bright*5); Serial.println(bright); delay(50);}
